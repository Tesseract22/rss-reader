...
const gl = @import("gl");
pub const Vec2 = gl.Vec2;
pub const Vec3 = gl.Vec3;
pub const Vec4 = gl.Vec4;
pub const Vec2u = gl.Vec2u;
pub const Vec3u = gl.Vec3u;
pub const Vec2i = gl.Vec2i;
pub const v2add = gl.v2add;
pub const v2sub = gl.v2sub;
pub const v2scal = gl.v2scal;
pub const v2eq = gl.v2eq;
pub const v2eq_approx = gl.v2eq_approx;
pub const v2splat = gl.v2splat;
pub fn v2pixels(v: Vec2) Vec2 {
    return .{ ctx.pixels(v[0]), ctx.pixels(v[1]) };
}
