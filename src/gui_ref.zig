...
const vs_src = @embedFile("resources/vertex.glsl");
const fs_src = @embedFile("resources/fragment.glsl");
...
pub fn main() !void {
    ...
    const vertexes = [_]VertexData {
        .{ .pos = .{0.5, 0.5, 0},   .rgb = .{1, 0, 0}, .tex = .{1, 1} },
        .{ .pos = .{0.5, -0.5, 0},  .rgb = .{1, 0, 0}, .tex = .{1, 0} },
        .{ .pos = .{-0.5, -0.5, 0}, .rgb = .{1, 0, 0}, .tex = .{0, 0} },
        .{ .pos = .{-0.5, 0.5, 0},  .rgb = .{1, 0, 0}, .tex = .{0, 1} },
    };
